...
//Name: FloatingRepulsorAnimation.ma
//Last modified: Tue, Nov 05, 2013 11:00:31 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.25893857034144524 -0.13502078948023311 -8.2395589183336853 ;
	setAttr ".r" -type "double3" 899.06164725241933 -1801.7999999978781 3.1075438163973374e-018 ;
...
createNode animCurveTL -n "pSphere3_translateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 25 -0.15732005047937697 48 0.0075107344696021539;
...
createNode animCurveTA -n "pSphere3_rotateY";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0 25 -180.1733518044268 48 -358.173838330899;
...
createNode animCurveTU -n "pSphere3_scaleX";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0.55304748529854475;
...
// End of FloatingRepulsorAnimation.ma
